// JHERBOTS:
// Extract from qvis tool (https://github.com/quiclog/qvis)
// qlog-abr can be found at the bottom
...
export type EventType = ConnectivityEventType | TransportEventType | SecurityEventType | RecoveryEventType | HTTP3EventType | QPACKEventType | ABREventTypes | GenericEventType;
